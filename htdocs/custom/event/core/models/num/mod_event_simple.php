...
dol_include_once("/event/core/models/modules_event.php");
 ...
 */
class mod_event_simple extends ModeleNumRefEvent
{
	...
	*/
    function getNextValue($objsoc=0,$event='')
    {
		...
		{
			dol_syslog("mod_event_simple::getNextValue sql=".$sql);
			return -1;
		}
